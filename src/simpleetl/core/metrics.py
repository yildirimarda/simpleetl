...
class MetricsCollector:
    ...
    def _initialize_default_metrics(self) -> None:
        ...
        self.histogram(
            "etl_job_duration_seconds", "Duration of ETL job execution in seconds"
        )
        self.histogram(
            "etl_records_processed_total", "Total number of records processed"
        )
        self.histogram(
            "etl_read_duration_seconds", "Duration of data read operations in seconds"
        )
        self.histogram(
        ...
        self.histogram(
            "etl_write_duration_seconds", "Duration of data write operations in seconds"
        )
    ...
    def _get_metrics_json(self) -> str:
        ...
        for name, histogram_metric in self._histograms.items():
            entries.extend(self._histogram_json_entries(name, histogram_metric))
